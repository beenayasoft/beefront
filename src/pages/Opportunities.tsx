...
export default function Opportunities() {
  ...
  const handleMarkAsWon = async (opportunity: Opportunity) => {
    try {
      ...
      const updatedOpportunity = await opportunityService.updateStage(opportunity.id, 'won');
  ...
  const handleConfirmLoss = useCallback(async (data: { lossReason: LossReason; lossDescription?: string }) => {
    ...
    try {
      ...
      const updatedOpportunity = await opportunityService.markAsLost(lossFormModal.data.id, {
  ...
  const handleFormSubmit = useCallback(async (formData: Partial<Opportunity>) => {
    ...
    try {
      ...
      if (opportunityFormModal.data) {
        ...
        const updatedOpportunity = await opportunityService.updateOpportunity(opportunityFormModal.data.id, formData);
